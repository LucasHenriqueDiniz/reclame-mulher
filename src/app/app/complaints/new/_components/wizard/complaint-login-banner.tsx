...
export function ComplaintLoginBanner() {
  return (
    <div className="w-full rounded-2xl px-6 py-7 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-r from-[#1565C0] via-[#0D47A1] to-[#075599] relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="flex flex-col gap-4 items-end relative z-10">
        ...
        <Link href="/login">
          ...
          >
            <LogIn className="w-4 h-4 text-[#1565C0]" />
            <span className="font-['Poppins'] font-bold text-[#1565C0] text-sm">
