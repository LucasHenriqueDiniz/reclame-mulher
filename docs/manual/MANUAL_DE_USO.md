...
![Página inicial da ComunicaMulher. No alto, uma barra com o nome da plataforma e os links Home, Empresas, Blog e Buscar. No centro, sobre a foto de três mulheres usando o celular, a frase "Conectando vozes que transformam comunidades" e um campo de busca com o botão Pesquisar.](img/01-home.png)
...
![Perfil público da Construtora X. No topo, o nome da empresa com um selo escrito VERIFICADA e o botão Reclamar. Abaixo, quatro números: tempo médio de resposta, taxa de resolução de 33%, um diálogo ativo e um caso resolvido. Mais abaixo, a lista de reclamações recentes com etiquetas Aberta, Respondida e Resolvida, e um quadro Sobre a empresa com razão social e CNPJ.](img/03-perfil-da-empresa.png)
...
![Tela com a pergunta "Como você vai usar a plataforma?" e dois cartões lado a lado. O da esquerda, Pessoa, para mulheres que desejam registrar problemas. O da direita, Empresa, para empresas que desejam responder às reclamações. Cada cartão tem um link: Continuar como pessoa e Continuar como empresa.](img/10-criar-conta.png)
...
![Formulário Cadastro de pessoa, marcado como Passo 1 de 2. Campos para nome completo, CPF, e-mail, senha e confirmação de senha. Abaixo, uma caixa para marcar que aceita os termos de uso e a política de privacidade, e o botão Continuar.](img/11-dados-da-conta.png)
...
![Tela de entrada, com campos para e-mail e senha e o botão Entrar.](img/12-entrar.png)
...
![Primeira etapa do formulário. No alto, a barra de progresso com as quatro etapas: Histórico, Descrição, Fotos e Finalizar, com a primeira marcada. A pergunta é "Você já reclamou sobre isso em outro lugar?", com duas opções: "Sim, já reclamei" e "Não, é a primeira vez", esta última já marcada. Abaixo, um aviso de que é possível voltar e mudar essa informação depois.](img/30-etapa-1.png)
...
![Segunda etapa, Descrição. Título "Conte o que aconteceu" e o subtítulo "Escreva de forma simples. Não precisa usar palavras difíceis". Três campos preenchidos: qual é o problema, com "Barulho de obra depois das dez da noite"; conte com mais detalhes, com um texto explicando que as máquinas trabalham até as duas da manhã; e onde aconteceu, com "Rua das Flores, 123 — Centro". Ao pé, um aviso azul: não coloque seu CPF, RG ou dados bancários aqui.](img/31-etapa-2.png)
...
![Terceira etapa, Fotos. Pergunta "Quer enviar uma foto?", com o aviso de que é opcional. Uma caixa azul explica que quem puder ver o relato também poderá abrir o que for anexado. Abaixo, uma área tracejada onde arrastar arquivos, com a informação de que aceita PNG, JPG, JPEG ou PDF. Ao pé, os botões Voltar e Continuar sem foto.](img/32-etapa-3.png)
...
![Quarta etapa, Finalizar. Título "Quase pronto!". Quatro campos: qual tipo de problema, preenchido com Infraestrutura; qual projeto da empresa, opcional; quão urgente é, preenchido com Média; e quem mais está sendo afetado, preenchido com Vizinhos e comunidade. Abaixo, duas chaves para ligar e desligar: "Quero fazer este relato sem mostrar meu nome", desligada, e "Quero que outras pessoas possam ver este relato", ligada. Ao pé, os botões Voltar e Enviar relato.](img/33-etapa-4.png)
...
![Página com os relatos de Maria Silva. No alto, o nome, a cidade, a quantidade de relatos e o botão Começar um novo relato. Abaixo, quatro abas: Últimas, Não Respondidas, Respondidas e Concluídas. Na lista, dois relatos com seus números, a empresa, a data e as etiquetas Aberta e Resolvida.](img/40-meus-relatos.png)

*Sua lista de relatos. As abas separam por situação.*

No celular a mesma página fica em uma coluna só:

![A mesma lista de relatos vista no celular. Tudo em uma coluna: o nome, o botão Começar um novo relato, as abas e o primeiro relato com a etiqueta Aberta.](img/40-meus-relatos-celular.png)
...
![Página de um relato ainda sem resposta. No alto, uma faixa azul com o título "Atraso na entrega de documentação da obra", o número do relato e a etiqueta Aberta. Abaixo, a empresa, a data de abertura e os botões Apoiar, Compartilhar e Reportar. Em seguida, o texto do relato assinado por Maria Silva, e um espaço para escrever resposta.](img/41-relato-aberto.png)
...
![Página de um relato respondido. A etiqueta no alto é Respondida. O texto do relato aparece assinado como "Autor (anônimo)". Logo abaixo, em um bloco destacado, a resposta de João Costa, da Construtora X: "Prezada, estamos verificando a autorização e entraremos em contato em até 48h". No fim, a caixa Enviar resposta com o botão de mesmo nome.](img/42-conversa-com-a-empresa.png)
...
![Painel da Construtora X. No alto, o nome da empresa com o selo Verificada e as abas Reclamações, Projetos e Configurações. Cinco quadros com números: 3 reclamações recebidas, 1 caso resolvido, 1 sem resposta, 33% de taxa de resolução e 1 projeto ativo. Abaixo, um campo de busca, filtros por situação, e a lista dos três relatos. O segundo aparece assinado como "Autora anônima".](img/60-painel-da-empresa.png)
